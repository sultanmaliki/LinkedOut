export declare const companyReplies: import('drizzle-orm/pg-core').PgTableWithColumns<{
  name: 'company_replies';
  schema: undefined;
  columns: {
    id: import('drizzle-orm/pg-core').PgColumn<
      {
        name: 'id';
        tableName: 'company_replies';
        dataType: 'string';
        columnType: 'PgUUID';
        data: string;
        driverParam: string;
...
export declare const companyRepliesRelations: import('drizzle-orm').Relations<
  'company_replies',
  {
