    ...
    status: import('drizzle-orm/pg-core').PgColumn<
      {
        ...
        data: 'PENDING' | 'ACCEPTED' | 'DECLINED' | 'EXPIRED' | 'WITHDRAWN';
        driverParam: string;
        notNull: true;
        hasDefault: true;
        isPrimaryKey: false;
        isAutoincrement: false;
        hasRuntimeDefault: false;
        enumValues: ['PENDING', 'ACCEPTED', 'DECLINED', 'EXPIRED', 'WITHDRAWN'];
        baseColumn: never;
        identity: undefined;
        generated: undefined;
      },
...
export declare const opportunitiesRelations: import('drizzle-orm').Relations<
  'opportunities',
  {
