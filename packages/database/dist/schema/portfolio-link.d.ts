export declare const portfolioLinks: import('drizzle-orm/pg-core').PgTableWithColumns<{
...
export declare const portfolioLinksRelations: import('drizzle-orm').Relations<
  'portfolio_links',
  {
