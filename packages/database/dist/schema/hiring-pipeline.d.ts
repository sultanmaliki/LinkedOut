export declare const hiringPipelines: import('drizzle-orm/pg-core').PgTableWithColumns<{
  name: 'hiring_pipelines';
  schema: undefined;
  columns: {
    id: import('drizzle-orm/pg-core').PgColumn<
      {
        name: 'id';
        tableName: 'hiring_pipelines';
        dataType: 'string';
        columnType: 'PgUUID';
        data: string;
        driverParam: string;
...
export declare const hiringPipelinesRelations: import('drizzle-orm').Relations<
  'hiring_pipelines',
  {
