...
> **Status: Deferred, not implemented.** No AI/ML integration exists in the codebase. This is a design sketch from early planning, kept for reference in case the product direction changes — see [vision.md](vision.md) "AI as an Assistant" and Non-Goals, and [decisions.md](decisions.md) D-016. It is not on the current [roadmap](roadmap.md).
